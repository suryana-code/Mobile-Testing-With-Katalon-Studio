...
while (attempt <= maxAttempts) {
    try {
        ...
        Mobile.delay(3)
        '<<< value searching'
        Mobile.setText(findTestObject('txt_Cari Produk Lainnya (searchbar Lainnya)'), 'pulsa', 0)
        Mobile.delay(5)
        Mobile.pressBack()
...
Mobile.scrollToText('three', FailureHandling.OPTIONAL)
...
Mobile.verifyElementText(findTestObject('Transaksi Pulsa/validate_Minimal Nomor Telepon 6 karakter'), 'Nomor Telepon harus diisi')
...
Mobile.verifyElementNotVisible(findTestObject('Transaksi Pulsa/Lay_list produk (list produk pertama Pulsa)'), 5, FailureHandling.OPTIONAL)
...
Mobile.waitForElementPresent(findTestObject('Transaksi Pulsa/Produk Pulsa/txt_THREE (product)'), 60, FailureHandling.STOP_ON_FAILURE)

valuenotlpn = Mobile.getText(findTestObject('Transaksi Pulsa/fld_Masukan No Telepon'), 0)

Mobile.tap(findTestObject('Transaksi Pulsa/Produk Pulsa/txt_THREE (product)'), 0, FailureHandling.OPTIONAL)
...
price_selected = Mobile.getText(findTestObject('Transaksi Pulsa/Nominal Transaksi/nml_Rp1.xxx (price)'), 0)

Mobile.tap(findTestObject('Transaksi Pulsa/Nominal Transaksi/nml_Rp1.xxx (price)'), 0)
...
Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/txt_Masukkan PIN Saat Ini'), 'Masukkan PIN Saat Ini')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/txt_Masukkan PIN Anda'), 'Masukkan PIN Anda')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/txtLupa dengan PIN Anda'), 'Lupa dengan PIN Anda?')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/btn_Atur Ulang'), 'Atur Ulang')
...
Mobile.setText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/txt_Masukkan PIN Anda'), '123456', 0)
...
Mobile.setText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/txt_Masukkan PIN Anda'), '111111', 0)
...
Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/Halaman Berhasil/txt_Pembayaran Berhasil'), 'Pembayaran Berhasil')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/Halaman Berhasil/android.widget.TextView - Transaksi Sedang diproses'), 'Transaksi Sedang diproses')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/Halaman Berhasil/btn_Lihat Halaman Riwayat'), 'Lihat Halaman Riwayat')

Mobile.verifyElementText(findTestObject('Transaksi Pulsa/Nominal Transaksi/Konfirmasi Pembayaran/PIN Topindo/Halaman Berhasil/btn_Kembali Ke Home'), 'Kembali Ke Home')
